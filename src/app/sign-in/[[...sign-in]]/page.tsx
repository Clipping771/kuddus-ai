    ...
    <div className="flex items-center justify-center min-h-screen bg-[#0A0A0A] p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <SignIn 
          appearance={{
            elements: {
              formButtonPrimary: "bg-emerald-500 hover:bg-emerald-600 text-neutral-950 font-bold",
              ...
              formFieldInput: "bg-neutral-950 border border-neutral-800 text-neutral-100 focus:border-emerald-500",
